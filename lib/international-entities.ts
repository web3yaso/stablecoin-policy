...
const HAND_CURATED: Entity[] = [
  // ─────────── EU REGION ───────────
  {
    ...
    news: [
      {
        id: "eu-mica-live",
        headline: "MiCA becomes fully applicable across the EU",
        source: "EUR-Lex",
        date: "2024-12-30",
        url: "https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=LEGISSUM%3A4626998",
        summary: "EUR-Lex confirms that MiCA applies from 30 December 2024, with the stablecoin provisions for asset-referenced tokens and e-money tokens already applying from 30 June 2024.",
      },
      {
        id: "eu-circle-emi",
        ...
        source: "CoinDesk",
        date: "2024-07-01",
        url: "https://www.coindesk.com/business/2024/07/01/stablecoin-issuer-circle-snags-mica-compliant-emi-license-for-europe/",
      ...
      {
        id: "eu-tether-mica",
        headline: "ESMA sets timeline for non-MiCA-compliant stablecoins",
        source: "ESMA",
        date: "2025-01-17",
        ...
        summary: "ESMA and the European Commission published guidance on non-MiCA-compliant ARTs and EMTs, telling national regulators to ensure crypto-asset service providers comply as soon as possible and no later than the end of Q1 2025.",
      },
      {
        id: "eu-eba-significant-tokens",
        headline: "EBA publishes MiCA hub for asset-referenced and e-money tokens",
        source: "European Banking Authority",
        date: "2025-01-16",
        url: "https://eba.europa.eu/regulation-and-policy/asset-referenced-and-e-money-tokens-mica",
        summary: "The EBA maintains the MiCA policy hub for ART and EMT issuers, including authorisation requirements, technical standards, reporting templates, guidelines, and supervisory materials.",
      },
    ],
    stablecoinMeta: {
      code: "EU",
  ...
  },
  {
    ...
    contextBlurb:
      "Africa does not have a single continent-wide stablecoin framework. The tracked African jurisdictions here skew restrictive: Algeria broadly prohibits virtual-currency activity, while Egypt blocks crypto issuance, trading, promotion, and platform operation without central-bank approval and has not opened a private stablecoin licensing route. The region should be read as a patchwork of national rules rather than a passportable regime like MiCA.",
    legislation: [
      {
        id: "africa-algeria-virtual-currency-ban",
        billCode: "Algeria · Financial Law 2018",
        title: "Virtual currency prohibition",
        summary:
      ...
      {
        id: "africa-egypt-cbe-crypto-restrictions",
        billCode: "Egypt · Law No. 194 of 2020",
        title: "Central Bank and Banking Sector Law crypto restrictions",
        summary:
    ...
    keyFigures: [
      {
        id: "africa-bank-of-algeria",
        name: "Bank of Algeria",
        role: "Central bank and payments authority in a jurisdiction where virtual-currency use is broadly prohibited.",
        party: "N/A",
        stance: "restrictive",
      },
      {
        id: "africa-central-bank-of-egypt",
        name: "Central Bank of Egypt",
        role: "Central bank and licensing authority for banking, payment, and crypto-related activity in Egypt.",
        party: "N/A",
        stance: "restrictive",
      },
    ],
    ...
    stablecoinMeta: {
      ...
      lastUpdated: "2025-01-01",
      summaryEn:
        "Africa has no single stablecoin passporting regime. The currently tracked African jurisdictions are restrictive: Algeria broadly bans virtual-currency activity, and Egypt requires central-bank approval for crypto issuance, trading, promotion, and platform operation while offering no open private stablecoin issuer pathway.",
      tags: [
      ...
      classificationNote:
        "Stablecoins are not handled under a single regional classification; Algeria and Egypt treat them within broader virtual-currency or cryptocurrency restrictions.",
      allowsFiatBacked: false,
      allowsAlgorithmic: false,
      allowsAssetBacked: false,
      regulators: [
        {
          id: "africa-reg-bank-of-algeria",
          name: "Bank of Algeria",
          role: "Central bank and payments authority for Algeria.",
          websiteUrl: "https://www.bank-of-algeria.dz/",
          isPrimary: true,
        },
        {
          id: "africa-reg-cbe",
          name: "Central Bank of Egypt",
          acronym: "CBE",
          role: "Central bank and licensing authority for Egypt's banking and payments perimeter.",
          websiteUrl: "https://www.cbe.org.eg/",
          isPrimary: true,
        },
      ],
    },
  ...
  // ─────────── ASIA REGION ───────────
  {
    ...
    news: [
      ...
      },
      {
        ...
        date: "2023-06-01",
        url: "https://www.fsa.go.jp/en/news/2022/20221207/01.pdf",
      ...
      {
        id: "asia-china-ecny",
        headline: "China reiterates virtual-currency trading restrictions as private stablecoins remain banned",
        source: "State Council of China",
        date: "2021-09-24",
        url: "https://english.www.gov.cn/statecouncil/ministries/202109/24/content_WS614dc30bc6d0df57f98e0c84.html",
        summary: "Chinese authorities reiterated the prohibition on virtual-currency trading and related private crypto activity, while China continues to develop the official e-CNY system.",
      },
    ],
    stablecoinMeta: {
      code: "AP",
